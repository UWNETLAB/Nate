...
#     ring_avg_dissims = []
#     bridge_avg_dissims = []
#     for batch_list in batch(auth_list, 10):
#         comp_list = []
...
#                             alter_dissim = create_average_dissim_gpu(alter, alter_2_list_trim, comp_dict, dissim_matrix)
...
# def create_average_dissim_gpu(ego, alters, index_dict, matrix):
...
#                 alter_list = auth_alt_dict[author]
#                 alter_dissim = create_average_dissim_gpu(author, alter_list, comp_dict, dissim_matrix)
#                 alters_avg_dissims.append(alter_dissim)
#             else:
...
#     for batch_list in batch(auth_list, 5):
#         comp_list = []
#         for author in batch_list:
#             comp_list += [author]
#             if author in auth_alt_dict and len(auth_alt_dict[author]) > 0:
